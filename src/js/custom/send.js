...
function getInputValue() {
    ...
    const confirm = (`Sending ${amounthnt} HNT, To ${address}`).replace(/,/g, '\n\n');
    alert(confirm);
    ...
    const result = (`Payee: ${payee}, Amount: ${hnt_sent} HNT, Fee: ${fee}, Nonce: ${nonce}, Memo: ${memo}, Hash: ${hash} `).replace(/,/g, '\n\n')
    alert(result);
